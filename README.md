...
<p align="center">
  <b>Lightning-Fast Trading Bot for Instant Profits on Raydium</b>
</p>
...
- 🚀 **Instant Sniping**: Execute buy transactions in milliseconds when liquidity is added to an SPL token
- 💰 **Auto Take Profit**: Secure gains with automatic sells at your target price
- 📊 **Strategic Trading**: Execute repeated buy orders to average down or scale into positions
...
![GIF](https://github.com/0xkrevX/gif/raw/main/asiq.gif)
